...
export default await Env.create(new URL('../', import.meta.url), {
  ...
  */
  ...
  /*
  |----------------------------------------------------------
  | Variables for configuring SMTP mail
  |----------------------------------------------------------
  */
  ...
  MAIL_THROTTLE_WINDOW_MS: Env.schema.number.optional(),
  MAIL_THROTTLE_MAX: Env.schema.number.optional(),
  ...
  */
  ...
  /*
  |----------------------------------------------------------
  | Variables for Firebase Cloud Messaging
  |----------------------------------------------------------
  */
